...
import 'package:machine_learning_flutter_app/Dialogs.dart';
            ...
            child: GestureDetector(
              child: FlatButton(
                onPressed: () => dailogs.information(
                    context,
                    'About',
                    'Basically it detect the skin tone and suggest product to you.  ',
                    '--------------------------',
                    'Skin tone Detection',
                    'Version: 1.0',
                    'Developer: Ganesha Maheshwari & Wassiullah Soomro',
